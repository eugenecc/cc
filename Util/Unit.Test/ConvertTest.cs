...
namespace Util.Tests
{
    ...
    public class ConvertHelperTest
    {
        ...
        public void TestToInt()
        {
            ...
            Assert.AreEqual(1778020, Util.ConvertHelper.ToInt("1778019.7801684"));
        }
        ...
        {
            Assert.IsNull(Util.ConvertHelper.ToDoubleOrNull(null));
        }
        ...
        {
            Assert.IsNull(Util.ConvertHelper.ToDoubleOrNull(""));
        }
        ...
        {
            Assert.IsNull(Util.ConvertHelper.ToDoubleOrNull("1A"));
        }
        ...
        {
            Assert.AreEqual(0, Util.ConvertHelper.ToDoubleOrNull("0"));
        }
        ...
        {
            Assert.AreEqual(1.2, Util.ConvertHelper.ToDoubleOrNull("1.2"));
        }
        ...
        {
            Assert.AreEqual(0, Util.ConvertHelper.ToDecimal(null));
        }
        ...
        {
            Assert.AreEqual(0, Util.ConvertHelper.ToDecimal(""));
        }
        ...
        {
            Assert.AreEqual(0, Util.ConvertHelper.ToDecimal("1A"));
        }
        ...
        {
            Assert.AreEqual(1.2M, Util.ConvertHelper.ToDecimal("1.2"));
        }
        ...
        {
            Assert.AreEqual(12.24M, Util.ConvertHelper.ToDecimal("12.235", 2));
        }
        ...
        public void TestToGuid()
        {
            Assert.AreEqual(new Guid("B9EB56E9-B720-40B4-9425-00483D311DDC"),
                Util.ConvertHelper.ToGuid("B9EB56E9-B720-40B4-9425-00483D311DDC"));
        }
        ...
        {
            Assert.AreEqual(new Guid("B9EB56E9-B720-40B4-9425-00483D311DDC"),
                Util.ConvertHelper.ToGuidOrNull("B9EB56E9-B720-40B4-9425-00483D311DDC"));
        }
